...
public class LoginBD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jtxtNickName);
        jtxtNickName.setBounds(200, 130, 175, 40);
        ...
        jPanel2.add(jpasswd);
        jpasswd.setBounds(200, 180, 175, 40);
        ...
        jPanel2.add(jbAcceder);
        jbAcceder.setBounds(390, 180, 60, 40);
        ...
        jPanel2.add(jbCrearNuevoUsuario);
        jbCrearNuevoUsuario.setBounds(290, 261, 175, 30);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestionbasedatos/images/loginPostgresq.png"))); // NOI18N
        jPanel2.add(jLabel2);
        jLabel2.setBounds(0, 0, 560, 344);
    ...
    private void jtxtNickNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtxtNickNameFocusGained
        if(jtxtNickName.getText().equals("nick")){
